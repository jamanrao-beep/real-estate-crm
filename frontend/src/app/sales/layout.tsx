...
import { LogOut, Briefcase, IndianRupee, ReceiptIndianRupee } from "lucide-react";
            ...
            <div className="flex">
              <div className="flex-shrink-0 flex items-center gap-3 pr-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-ink-soft uppercase tracking-wider font-medium">Sales Workspace</span>
                </div>
              </div>
